---
title: Geomorfologi dan Penggunaan Lahan
permalink: /docs/Geomorfologi/
layout: single
toc: true
toc_sticky: true
sidebar:
...
---
# Pendahuluan
- Geomorfologi adalah ilmu (_logos_) yang mempelajari bentuk permukaan (_morfos_) Bumi (_geos_).
...
Pesisir primer terbentuk karena tenaga dari daratan. Pesisir ini disebut juga pesisir muda, karena pengaruh tenaga pembentuk awal lebih dominan dari tenaga gelombang dan arus laut.
  1. Pesisir Erosi Daratan (_Land Erosion Coast_)\
  ...
  Pesisir struktural terbentuk dari gawir sesar. Pesisir ini disebut memiliki tebing sejati (_true cliff_), artinya, bentukan tebing aktif mengalami erosi.
